...
func main() {
	...
	String("").Random(10).Println()
	String("").Random(10, ASCII_LETTERS).Println()
	String("").Random(10, DIGITS).Println()
	String("").Random(10, PUNCTUATION).Println()
	...
	// TryBigInt parses an arbitrary-precision integer into a Result
	fmt.Println(String("123456789012345678901234567890").TryBigInt()) // Ok(123456789012345678901234567890)
	fmt.Println(String("12x").TryBigInt())                            // Err(invalid big integer: "12x")
}
